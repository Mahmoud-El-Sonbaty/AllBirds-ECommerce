    ...
    public class AllBirdsContext(DbContextOptions<AllBirdsContext> dbContextOptions) : IdentityDbContext<CustomUser, IdentityRole<int>, int>(dbContextOptions)
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Category>().HasData(
                ...
                new Category { Id = 9, NameAr = "ملابس داخلية", NameEn = "Underwear", ParentCategoryId = 8, Level = 2, IsParentCategory = false, CreatedBy = 1, Created = new DateTime(2024, 10, 19) },
                new Category { Id = 10, NameAr = "تي شيرتات", NameEn = "Tees", ParentCategoryId = 8, Level = 2, IsParentCategory = false, CreatedBy = 1, Created = new DateTime(2024, 10, 19) },
                new Category { Id = 11, NameAr = "نعال", NameEn = "Insoles", ParentCategoryId = 8, Level = 2, IsParentCategory = false, CreatedBy = 1, Created = new DateTime(2024, 10, 19) },
                new Category { Id = 12, NameAr = "بطاقات هدايا", NameEn = "Gift Cards", ParentCategoryId = 8, Level = 2, IsParentCategory = false, CreatedBy = 1, Created = new DateTime(2024, 10, 19) },
                ...
                new Category { Id = 34, NameAr = "عروض الرجال", NameEn = "Men's Sale", ParentCategoryId = 33, Level = 1, IsParentCategory = true, CreatedBy = 1, Created = new DateTime(2024, 10, 19) },
                ...
                new Category { Id = 37, NameAr = "عروض النساء", NameEn = "Women's Sale", ParentCategoryId = 33, Level = 1, IsParentCategory = true, CreatedBy = 1, Created = new DateTime(2024, 10, 19) },
                ...
                new Category { Id = 40, NameAr = "مميز", NameEn = "Featured", ParentCategoryId = 33, Level = 1, IsParentCategory = true, CreatedBy = 1, Created = new DateTime(2024, 10, 19) },
