    ...
    public class AllBirdsContext(DbContextOptions<AllBirdsContext> dbContextOptions) : IdentityDbContext<CustomUser, IdentityRole<int>, int>(dbContextOptions)
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Category>().HasData(
                ...
                new Category { Id = 7, NameAr = "الأكثر مبيعًا", NameEn = "Bestsellers", ParentCategoryId = 1, Level = 1, IsParentCategory = false, CreatedBy = 1, Created = new DateTime(2024, 10, 19) },
                new Category { Id = 8, NameAr = "ملابس والمزيد", NameEn = "Apparel & More", ParentCategoryId = 1, Level = 1, IsParentCategory = true, CreatedBy = 1, Created = new DateTime(2024, 10, 19) },
                new Category { Id = 9, NameAr = "ملابس داخلية", NameEn = "Underwear", ParentCategoryId = 9, Level = 2, IsParentCategory = false, CreatedBy = 1, Created = new DateTime(2024, 10, 19) },
                new Category { Id = 10, NameAr = "تي شيرتات", NameEn = "Tees", ParentCategoryId = 9, Level = 2, IsParentCategory = false, CreatedBy = 1, Created = new DateTime(2024, 10, 19) },
                new Category { Id = 11, NameAr = "نعال", NameEn = "Insoles", ParentCategoryId = 9, Level = 2, IsParentCategory = false, CreatedBy = 1, Created = new DateTime(2024, 10, 19) },
                new Category { Id = 12, NameAr = "بطاقات هدايا", NameEn = "Gift Cards", ParentCategoryId = 9, Level = 2, IsParentCategory = false, CreatedBy = 1, Created = new DateTime(2024, 10, 19) },
                new Category { Id = 13, NameAr = "مميز", NameEn = "Featured", ParentCategoryId = 1, Level = 1, IsParentCategory = true, CreatedBy = 1, Created = new DateTime(2024, 10, 19) },
                new Category { Id = 14, NameAr = "وصل حديثًا", NameEn = "New Arrivals", ParentCategoryId = 13, Level = 2, IsParentCategory = false, CreatedBy = 1, Created = new DateTime(2024, 10, 19) },
                new Category { Id = 15, NameAr = "هدايا أقل من $100", NameEn = "Gifts Under $100", ParentCategoryId = 13, Level = 2, IsParentCategory = false, CreatedBy = 1, Created = new DateTime(2024, 10, 19) },
                ...
                new Category { Id = 23, NameAr = "الأكثر مبيعًا", NameEn = "Bestsellers", ParentCategoryId = 16, Level = 1, IsParentCategory = false, CreatedBy = 1, Created = new DateTime(2024, 10, 19) },
                new Category { Id = 24, NameAr = "ملابس والمزيد", NameEn = "Apparel & More", ParentCategoryId = 16, Level = 1, IsParentCategory = true, CreatedBy = 1, Created = new DateTime(2024, 10, 19) },
                new Category { Id = 25, NameAr = "ملابس داخلية", NameEn = "Underwear", ParentCategoryId = 24, Level = 2, IsParentCategory = false, CreatedBy = 1, Created = new DateTime(2024, 10, 19) },
                new Category { Id = 26, NameAr = "تي شيرتات", NameEn = "Tees", ParentCategoryId = 24, Level = 2, IsParentCategory = false, CreatedBy = 1, Created = new DateTime(2024, 10, 19) },
                new Category { Id = 27, NameAr = "نعال", NameEn = "Insoles", ParentCategoryId = 24, Level = 2, IsParentCategory = false, CreatedBy = 1, Created = new DateTime(2024, 10, 19) },
                new Category { Id = 28, NameAr = "بطاقات هدايا", NameEn = "Gift Cards", ParentCategoryId = 24, Level = 2, IsParentCategory = false, CreatedBy = 1, Created = new DateTime(2024, 10, 19) },
                new Category { Id = 29, NameAr = "مميز", NameEn = "Featured", ParentCategoryId = 16, Level = 1, IsParentCategory = true, CreatedBy = 1, Created = new DateTime(2024, 10, 19) },
                new Category { Id = 30, NameAr = "وصل حديثًا", NameEn = "New Arrivals", ParentCategoryId = 29, Level = 2, IsParentCategory = false, CreatedBy = 1, Created = new DateTime(2024, 10, 19) },
                new Category { Id = 31, NameAr = "هدايا أقل من $100", NameEn = "Gifts Under $100", ParentCategoryId = 29, Level = 2, IsParentCategory = false, CreatedBy = 1, Created = new DateTime(2024, 10, 19) },
                ...
                new Category { Id = 33, NameAr = "عروض", NameEn = "Sale", ParentCategoryId = 0, Level = 0, IsParentCategory = true, CreatedBy = 1, Created = new DateTime(2024, 10, 19) },
                new Category { Id = 34, NameAr = "عروض الرجال", NameEn = "Men's Sale", ParentCategoryId = 33, Level = 1, IsParentCategory = false, CreatedBy = 1, Created = new DateTime(2024, 10, 19) },
                new Category { Id = 35, NameAr = "عروض الأحذية", NameEn = "Sale Shoes", ParentCategoryId = 34, Level = 2, IsParentCategory = false, CreatedBy = 1, Created = new DateTime(2024, 10, 19) },
                new Category { Id = 36, NameAr = "عروض الملابس والجوارب", NameEn = "Sale Apparel & Socks", ParentCategoryId = 34, Level = 2, IsParentCategory = false, CreatedBy = 1, Created = new DateTime(2024, 10, 19) },
                new Category { Id = 37, NameAr = "عروض النساء", NameEn = "Women's Sale", ParentCategoryId = 33, Level = 1, IsParentCategory = false, CreatedBy = 1, Created = new DateTime(2024, 10, 19) },
                new Category { Id = 38, NameAr = "عروض الأحذية", NameEn = "Sale Shoes", ParentCategoryId = 37, Level = 2, IsParentCategory = false, CreatedBy = 1, Created = new DateTime(2024, 10, 19) },
                new Category { Id = 39, NameAr = "عروض الملابس والجوارب", NameEn = "Sale Apparel & Socks", ParentCategoryId = 37, Level = 2, IsParentCategory = false, CreatedBy = 1, Created = new DateTime(2024, 10, 19) },
                new Category { Id = 40, NameAr = "مميز", NameEn = "Featured", ParentCategoryId = 33, Level = 1, IsParentCategory = false, CreatedBy = 1, Created = new DateTime(2024, 10, 19) },
                new Category { Id = 41, NameAr = "عروض الرجال", NameEn = "Men's Sale", ParentCategoryId = 40, Level = 2, IsParentCategory = false, CreatedBy = 1, Created = new DateTime(2024, 10, 19) },
                new Category { Id = 42, NameAr = "عروض النساء", NameEn = "Women's Sale", ParentCategoryId = 40, Level = 2, IsParentCategory = false, CreatedBy = 1, Created = new DateTime(2024, 10, 19) }
            );
            // Seeding Products
